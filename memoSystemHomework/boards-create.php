        ...
        <div class="row">
            <div class="col-6 mx-auto">
                <div class="card shadow">
                    <div class="card-body">
                        <h1 class="card-title">New Board</h1>
                        <form action="boards-store.php" method="POST">
                            <div class="form-group">
                              <label for="name">Board Name</label>
                              <input type="text" name="name" id="name" class="form-control" placeholder="e.g Programming" required>
                            </div>
                            <div class="form-group">
