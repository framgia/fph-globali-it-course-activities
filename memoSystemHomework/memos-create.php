        ...
        <div class="row">
            <div class="col-8 mx-auto">
                <div class="card shadow">
                    <div class="card-body">
                        <h1 class="card-title">New Memo under <?php echo $board['name'] ?></h1>
                        <form action="memos-store.php" method="POST">
                            ...
                            <div class="form-group">
                              ...
                              <textarea class="form-control" name="contents" id="contents" style="resize: none;" required></textarea>
                            </div>
                            <a class="btn btn-dark" href="boards.php" role="button">Back</a>
                            <button type="submit" class="btn btn-success">Create Memo</button>
                        </form>
                    </div>
                </div>
            </div>
